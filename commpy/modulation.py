...
class Modem:
    ...
    def modulate(self, input_bits):
        ...
        index_list = list(map(lambda i: bitarray2dec(input_bits[i:i+self.num_bits_symbol]), \
                          range(0, len(input_bits), self.num_bits_symbol)))
    ...
    def demodulate(self, input_symbols, demod_type, noise_var = 0):
        ...
        if demod_type == 'hard':
            ...
            demod_bits = hstack(list(map(lambda i: dec2bitarray(i, self.num_bits_symbol), index_list)))
...
class PSKModem(Modem):
    ...
    def __init__(self, m):
        ...
        self.constellation = array(list(map(self._constellation_symbol, self.symbol_mapping)))
...
class QAMModem(Modem):
    ...
    def __init__(self, m):
        ...
        self.constellation = array(list(map(self._constellation_symbol, list(product(mapping_array, repeat=2)))))
